...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { category_id: @pin.category_id, latitude: @pin.latitude, longitude: @pin.longitude, title: @pin.title }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { category_id: @pin.category_id, latitude: @pin.latitude, longitude: @pin.longitude, title: @pin.title }
    assert_redirected_to pin_path(assigns(:pin))
  end
