...
@property (nonatomic, strong) PSBubbleColor *bubbleColor;
@property (nonatomic, strong) PSBubbleColor *bubbleSelectedColor;

@end

@implementation PSContactPickerView
...
- (void)setup {
    ...
    PSContactBubble *contactBubble = [[PSContactBubble alloc] initWithName:@"Sample"];
...
- (void)addContact:(id)contact withName:(NSString *)name {
    ...
    PSContactBubble *contactBubble = [[PSContactBubble alloc] initWithName:name color:self.bubbleColor selectedColor:self.bubbleSelectedColor];
    if (self.font != nil){
...
- (void)removeAllContacts
{
    for(id contact in [self.contacts allKeys]){
        PSContactBubble *contactBubble = [self.contacts objectForKey:contact];
...
- (void)removeContact:(id)contact {
    ...
    PSContactBubble *contactBubble = [self.contacts objectForKey:contactKey];
    [contactBubble removeFromSuperview];
...
- (void)setBubbleColor:(PSBubbleColor *)color selectedColor:(PSBubbleColor *)selectedColor {
    ...
    for (id contactKey in self.contactKeys){
        PSContactBubble *contactBubble = (PSContactBubble *)[self.contacts objectForKey:contactKey];
...
- (void)removeContactBubble:(PSContactBubble *)contactBubble {
...
- (id)contactForContactBubble:(PSContactBubble *)contactBubble {
...
#pragma mark - PSContactBubbleDelegate Functions
