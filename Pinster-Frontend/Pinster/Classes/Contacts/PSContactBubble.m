...
@implementation PSContactBubble
...
- (id)initWithName:(NSString *)name color:(PSBubbleColor *)color selectedColor:(PSBubbleColor *)selectedColor {
    self = [super init];
    if (self){
        self.name = name;
        self.isSelected = NO;
        ...
        if (color == nil){
            color = [[PSBubbleColor alloc] initWithGradientTop:kBubbleColor gradientBottom:kBubbleColor border:kBubbleColor];
        }

        if (selectedColor == nil){
            selectedColor = [[PSBubbleColor alloc] initWithGradientTop:kBubbleColorSelected gradientBottom:kBubbleColorSelected border:kBubbleColorSelected];
        }
