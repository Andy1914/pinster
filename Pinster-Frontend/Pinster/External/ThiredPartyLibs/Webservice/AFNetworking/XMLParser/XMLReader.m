...
//    NSXMLParser *parser = parser;
    ...
    // Initialize the stack with a fresh dictionary
    [self.dictionaryStack addObject:[NSMutableDictionary dictionary]];
    [parser setShouldProcessNamespaces:(0 & XMLReaderOptionsProcessNamespaces)];
    [parser setShouldReportNamespacePrefixes:(0 & XMLReaderOptionsReportNamespacePrefixes)];
    [parser setShouldResolveExternalEntities:(0 & XMLReaderOptionsResolveExternalEntities)];
